...
#define MIXING_
PERS 2        // Number of steppers in your mixing extruder
...
*/
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 90*1.1 }
...
/**
   ...
   Override with M201
                                        X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
*/
#define DEFAULT_MAX_ACCELERATION      { 250, 250, 50, 5000 }
